/*
 * Hydro service worker.
 * Purpose: cache the app shell so it keeps working offline / from a home
...
// (there is no backend, so this mainly protects against a flaky first load).
